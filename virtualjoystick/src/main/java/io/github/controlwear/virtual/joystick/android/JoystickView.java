...
public class JoystickView extends View
    ...
    */
    ...
    public interface OnMoveListener {
         ...
         */
        void onMove(int angle, int strength, int positionX, int positionY);
    }
    ...
    */
    ...
    private int angleBeforeRelease;
    private int[] posBeforeRelease= new int[2];
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_UP) {
            ...
            if (mCallback != null)
                mCallback.onMove(getAngle(), getStrength(), getXPos(), getYPos());
        }
    ...
    public void resetButtonPosition() {
        release = true;
        angleBeforeRelease= getAngle();
        posBeforeRelease[0]= getXPos();
        posBeforeRelease[1]= getYPos();
        mPosX = mCenterX;
        mPosY = mCenterY;
    }
    ...
    public int getAngleBeforeRelease(){
      return angleBeforeRelease;
    }

    public int[] getPosBeforeRelease(){



        return posBeforeRelease;
    }
